...
setInterval(function () {
  ...
  for (i = 0; i < dragon.length; i++) {
    let text = dragon[i];
    text.textContent = "Flammenwerfer";
  }

  let dragonDesc = getElementsByText('Breathes fire at nearby enemies.', 'div');
  for (i = 0; i < dragonDesc.length; i++) {
    let text = dragonDesc[i];
    text.textContent = "Ze flammenwerfer invented will burn anything that crosses.";
  }
